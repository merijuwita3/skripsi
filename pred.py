...
def app():
    ...
    pm10 = st.number_input('Partikel Mikro 10 (PM 10)')
    pm25 = st.number_input('Partikel Mikro 2,5 (PM 2,5)')
    so2 = st.number_input('Sulfur Dioksida (SO2')
    co = st.number_input('Karbon Monoksida (CO)')
    o3 = st.number_input('Ozon (O3)')
    no2 = st.number_input('Nitrogen Dioksida (NO2)')
    hc = st.number_input('Hidrokarbon (HC)')
